...
function AddToListButton() {
  ...
  return (
  <div className="flex flex-row items-center gap-5 mt-5 mb-10">
  ...
  <div className="relative">
    ...
    <div
      className={`absolute ${buttonClicked ? 'flex' : 'hidden'} right-0 top-full mt-2 shadow-2xl border-2 border-white backdrop-blur-xl rounded-lg`}
    >
