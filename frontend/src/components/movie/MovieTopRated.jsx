...
function MovieTopRated() {
  ...
  return (
    <div style={{ backgroundColor: '#0a0a0a' }} className="min-h-[600px] pt-10 relative">
      ...
      <Link to={`movie-page/${movieType}`}><button className='bg-red-700  text-white text-xs lg:text-base md:text-base rounded py-1 lg:px-3 md:px-3  flex items-center'>View All <ChevronRight/></button></Link>
      </div>
